...
def test_api_key_validation():
    ...
    test_cases = [
        ...
        ("sk-example1234567890abcdef1234567890abcdef", True, "有效的 API Key"),
        ("sk-example2234567890abcdef1234567890abcdef", True, "有效的 API Key"),
        ("AIzaSyExample_GoogleAPIKey_Placeholder_1234567", True, "有效的 Google API Key"),
        ("bce-v3/ALTAK-ExampleQianfanAPIKeyPlaceholder/abcdef1234567890abcdef1234567890abcdef", True, "有效的千帆 API Key"),
        ("sk-or-v1-exampleOpenRouterKeyPlaceholder1234567890abcdef1234567890abcdef", True, "有效的 OpenRouter API Key"),
        ('"sk-example1234567890abcdef1234567890abcdef"', True, "带引号的有效 API Key"),
        ("'sk-example1234567890abcdef1234567890abcdef'", True, "带单引号的有效 API Key"),
    ]
