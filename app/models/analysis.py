...
class BatchAnalysisRequest(BaseModel):
    ...
    title: str = Field(..., description="批次标题")
    description: Optional[str] = None
    symbols: Optional[List[str]] = Field(None, min_items=1, max_items=500, description="股票代码列表（最多500个）")
    stock_codes: Optional[List[str]] = Field(None, min_items=1, max_items=500, description="股票代码列表(已废弃,使用symbols，最多500个)")
    parameters: Optional[AnalysisParameters] = None
