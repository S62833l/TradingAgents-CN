...
class RateLimitMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(self, app, default_rate_limit: int = 100):
        ...
        self.endpoint_limits = {
            "/api/analysis/single": int(os.environ.get("RATE_SINGLE", "100")),    # 单股分析
            "/api/analysis/batch": int(os.environ.get("RATE_BATCH", "50")),       # 批量分析
            "/api/screening/filter": int(os.environ.get("RATE_SCREEN", "100")),   # 股票筛选
